...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi mujer:\n\n Desde el primer mensaje supe que había algo distinto entre nosotras. Tu sonrisa, tu voz y tu manera de estar incluso a través de una pantalla me dan calma, como ese rayito de sol que entra y lo pone todo en paz..\n\nGracias por acompañarme en cada paso, por escucharme y entenderme aun en silencio,y por hacer que la distancia se sienta corta. Contigo aprendí que el amor también se construye con gestos sencillos, palabras honestas y tiempo compartido, aunque sea en llamadas de madrugada.\n\nTe amo más de lo que las palabras pueden expresar y me emociona todo lo que viene:más risas, más momentos, más fotos para ti y muchos cumpleaños juntas..`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Majo";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-07-05T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-12-03T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      ...
      `Cuenta regresiva para verte: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
